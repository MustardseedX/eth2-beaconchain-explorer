# ETH2 Deposit Contract (Validator Registration)
# Source: https://github.com/ethereum/eth2.0-specs/blob/v0.10.0/deposit_contract/contracts/validator_registration.vy
# 
# Vyper target 0.1.0b13.hotfix1761
# This is the original Vyper source code from the Ethereum 2.0 specs v0.10.0
# The ABI (abi.json) and Go bindings (deposit.go) are generated from this contract.
